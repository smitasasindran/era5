...
computed over each language's full corpus (occurrence-level, not
per-unique-word like v1 -- see faithful_units.py's docstring for why).

Also computes the Hindi penalty found in solution2/evaluate_tokenizer.py,
which wasn't part of what we'd been told about the grading rubric before
